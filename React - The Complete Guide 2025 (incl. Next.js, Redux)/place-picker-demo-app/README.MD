A Place Picker application that allows users to select places from a mock list of destinations they would like to visit, add them to a personalized list, and remove any in case they change their mind.
