Shopping cart demo project focusing on a mini online shop, where we can add products to the cart, view the selected cart, edit, update, or remove products, and proceed to checkout to complete the purchase.
