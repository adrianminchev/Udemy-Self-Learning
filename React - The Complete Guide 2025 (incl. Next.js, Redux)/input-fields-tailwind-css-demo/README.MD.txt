Input Fields Demo Project Using Different Features of the Tailwind CSS Library (the setup guide for the library: https://tailwindcss.com/docs/installation/using-vite)
